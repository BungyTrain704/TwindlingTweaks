...
import bungy.twindling.tweaks.main.screen.slot.ModFuelSlot;
import bungy.twindling.tweaks.main.screen.slot.ModResultSlot;
...
public class ObsidianForgerScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;

    public ObsidianForgerScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(4), new ArrayPropertyDelegate(4));
    }

    public ObsidianForgerScreenHandler(int syncId, PlayerInventory playerInventory,
                                       Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.OBSIDIAN_FORGER_SCREEN_HANDLER, syncId);
