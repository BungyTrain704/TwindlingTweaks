...
public class ObsidianForgerScreen extends HandledScreen<ObsidianForgerScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(TwindlingTweaks.MOD_ID, "textures/gui/obsidian_forger_gui.png");

    public ObsidianForgerScreen(ObsidianForgerScreenHandler handler, PlayerInventory inventory, Text title) {
