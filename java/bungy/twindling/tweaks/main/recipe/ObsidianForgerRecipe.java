...
public class ObsidianForgerRecipe implements Recipe<SimpleInventory> {
    ...
    public static class Type implements RecipeType<ObsidianForgerRecipe> {
        ...
        public static final String ID = "obsidian_forger";
    }
    ...
    public static class Serializer implements RecipeSerializer<ObsidianForgerRecipe> {
        ...
        @Override
        public ObsidianForgerRecipe read(Identifier id, JsonObject json) {
        ...
        @Override
        public ObsidianForgerRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, ObsidianForgerRecipe recipe) {
