...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    ALLUMINITE("alluminite", 30, new int[]{4, 7, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 2.2F, 0.1F, () -> {
        return Ingredient.ofItems(TwindlingTweaks.REINFORCED_ALUMINITE_INGOT);
    }),
    OBSIDIAN("obsidian", 42, new int[]{5, 8, 11, 5}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.5F, 0.3F, () -> {
